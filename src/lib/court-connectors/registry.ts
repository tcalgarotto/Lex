...
export const COURT_CONNECTOR_DEFINITIONS: CourtConnectorDefinition[] = [
  ...
  },
  {
    ...
    limitations: ["Lex não acessa a conta do advogado", "Sem senha, PIN, sessão ou certificado armazenado", "Automação depende de integração oficial futura"],
  ...
  },
  {
    ...
    limitations: ["API automatizada exige credenciais oficiais/habilitação", "Lex não calcula prazo final automaticamente"],
  ...
  },
  {
    ...
    limitations: ["Sem acesso automatizado à conta", "Sem certificado no Lex"],
