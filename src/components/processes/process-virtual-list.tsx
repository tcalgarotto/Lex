...
export function ProcessVirtualList(props: {
 ...
 return (
 <div ref={parentRef} className="h-[420px] overflow-auto rounded-xl border border-[color:var(--border-default)]">
 <div
 ...
 <div
 key={p.id}
 className="absolute left-0 top-0 w-full border-b border-[color:var(--border-subtle)] px-4 py-3"
