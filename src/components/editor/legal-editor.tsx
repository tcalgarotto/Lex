...
export function LegalEditor(props: {
 ...
 <div className="lex-glass-card rounded-2xl">
 <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[color:var(--border-default)] p-2">
 ...
 <ScrollArea className="lex-glass h-[560px] rounded-2xl p-3">
 <div className="mb-4 rounded-lg border border-[color:var(--border-default)] bg-[color:var(--surface-overlay-strong)] p-3">
 ...
 <span className="text-[color:var(--text-primary)]">{String(confidence["label"] ?? "—")}</span>
