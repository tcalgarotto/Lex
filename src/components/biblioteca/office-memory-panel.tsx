...
export function OfficeMemoryPanel(props: { initialMemories: OfficeMemoryRow[]; cases: CaseOption[] }) {
 ...
 Nada é criado automaticamente a partir de casos ou chats. Flags de modelo, estilo e inclusão na busca assistida só valem se você
 ...
 >
 <option value="WORKSPACE">Toda a equipa (workspace)</option>
