...
export function CaseDataOriginButton(props: {
 ...
 <dd className="max-h-48 overflow-auto whitespace-pre-wrap rounded border border-[color:var(--border-default)] bg-[color:var(--surface-overlay-strong)] p-2 text-[11px] text-foreground">
 {meta.sourceText}
 </dd>
 </div>
 ) : (
