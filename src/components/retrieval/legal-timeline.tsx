...
function NormTimelineCard({ timeline }: { timeline: NormTimeline }) {
 ...
 <ol className="mt-3 space-y-2 border-l border-[color:var(--border-default)] pl-4">
 {t.events.length === 0 && (
 ...
 <span
 className={cn("absolute -left-[21px] top-1 inline-flex size-3.5 items-center justify-center rounded-full bg-background ring-1 ring-white/15",
 )}
 >
