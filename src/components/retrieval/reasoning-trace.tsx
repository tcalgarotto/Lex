...
export function ReasoningTrace({ trace, rewrites }: { trace: LegalRetrievalTrace; rewrites: string[] }) {
 ...
 <span
 className={cn("mt-0.5 inline-flex size-4 shrink-0 items-center justify-center rounded-full text-[10px] font-semibold",
 i === 0 ? "bg-indigo-500/15 text-indigo-300" : "bg-[color:var(--surface-overlay-strong)] text-[color:var(--text-secondary)]",
 )}
 >
 {i + 1}
 </span>
