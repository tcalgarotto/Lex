      ...
      <div className="space-y-6">
        <Card className="border-white/10 bg-zinc-900/40">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Objetivo: mostrar que o Lex não é “chat com PDF”: ele mantém <span className="text-zinc-200">fontes</span>, <span className="text-zinc-200">confiança jurídica</span> e <span className="text-zinc-200">guardrails</span>.
            </p>
          </CardHeader>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="rounded-xl border border-white/10 bg-zinc-950/40 p-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Se não existir, rode <span className="text-zinc-200">npm run seed:demo-legal</span>.
                </p>
                <div className="mt-3">
        ...
        <Card className="border-white/10 bg-zinc-900/40">
          ...
          <CardContent className="flex flex-wrap gap-2">
            {proc ? (
              ...
              <p className="text-sm text-muted-foreground">
                Nenhum processo demo encontrado. Rode <span className="text-zinc-200">npm run seed:demo-legal</span>.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="border-white/10 bg-zinc-900/40">
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>
              - <span className="text-zinc-200">Fontes usadas pela IA</span>: tipo (documento/lei/jurisprudência), seção e link “abrir”.
            </p>
            <p>
              - <span className="text-zinc-200">Confiança jurídica</span>: label + justificativa curta.
            </p>
            <p>
              - <span className="text-zinc-200">Guardrail</span>: se a base for insuficiente, o Lex inicia avisando e evita afirmar artigos/prazos.
            </p>
          </CardContent>
        </Card>
      </div>
