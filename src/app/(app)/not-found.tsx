    ...
    <AppShell title="Página não encontrada">
      <div className="mx-auto max-w-3xl space-y-6">
        <Card className="flex flex-col items-center gap-3 p-8 text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-zinc-900/80 text-violet-300">
            <Compass className="size-6" />
          </div>
          <p className="text-sm font-medium uppercase tracking-wide text-violet-300">404</p>
