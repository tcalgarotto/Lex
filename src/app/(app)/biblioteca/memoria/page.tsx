...
export default async function BibliotecaMemoriaPage() {
  ...
  return (
    <AppShell title="Memória do escritório">
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-2">
            <h1 className="text-2xl font-semibold">Memória do escritório</h1>
            <p className="max-w-2xl text-sm text-muted-foreground">
              Textos curados por escopo (escritório, pessoal ou caso). Tudo é <strong className="text-foreground">opt-in</strong>
              : nada entra aqui automaticamente. Use flags só quando fizer sentido para modelo, estilo ou RAG futuro.
            </p>
          </div>
