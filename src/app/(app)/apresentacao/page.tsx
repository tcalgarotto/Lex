        ...
        <Card className="border-white/10 bg-zinc-900/40">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Não é “chat com PDF”. É <span className="text-zinc-200">memória jurídica + fontes verificáveis</span> + geração de peça no seu estilo, com guardrails contra alucinação.
            </p>
          </CardHeader>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="border-white/10 bg-zinc-900/40">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                2) No chat, o Lex recupera trechos relevantes (RAG) e responde com <span className="text-zinc-200">fontes usadas</span>.
              </p>
              <p>
          ...
          <Card className="border-white/10 bg-zinc-900/40">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                - <span className="text-zinc-200">Fontes primeiro</span>: cada resposta mostra o que foi efetivamente usado.
              </p>
              <p>
                - <span className="text-zinc-200">Confiança jurídica</span>: label + justificativa curta.
              </p>
              <p>
                - <span className="text-zinc-200">Memória do processo</span>: histórico e estratégia ficam consistentes ao longo do tempo.
              </p>
              <p>
                - <span className="text-zinc-200">Estilo do advogado</span>: perfil de escrita aplicado automaticamente.
              </p>
            </CardContent>
          </Card>
        </div>
