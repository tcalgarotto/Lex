...
export const metadata: Metadata = {
  title: "Termos de Uso — JustOS",
  description: "Condições de uso da plataforma JustOS para escritórios e profissionais do Direito.",
};
...
export default function TermosPage() {
  return (
    <LegalDocPage title="Termos de Uso" updatedLabel="Versão preliminar · alfa comercial">
      <section>
        <h2 className="text-lg font-semibold text-[color:var(--text-primary)]">1. O que é o JustOS</h2>
        <p>
          O JustOS é uma plataforma de apoio à atividade jurídica que ajuda escritórios e profissionais a
      ...
      <section>
        ...
        <p>
          O JustOS não substitui o exercício da advocacia nem a análise de um profissional habilitado. Todo
      ...
      <section>
        ...
        <p>
          ...
          que o JustOS processe esse conteúdo com a finalidade de prestar o serviço (indexação, busca,
      ...
      <section>
        ...
        <p>
          ...
          escritório — o JustOS não garante cobertura universal nem resultados processuais.
        </p>
      </section>
      <section>
