...
export default function GlobalError({
 ...
 return (
 <html lang="pt-BR">
 <body className="flex min-h-screen flex-col items-center justify-center bg-[color:var(--surface-elevated)] px-4 text-[color:var(--text-primary)]">
 <h2 className="text-lg font-semibold">{title}</h2>
 <p className="mt-2 max-w-md text-center text-sm text-[color:var(--text-secondary)]">{body}</p>
 ...
 target="_blank"
 rel="noreferrer"
 className="rounded-lg border-[0.5px] border-[color:var(--border-strong)] bg-[color:var(--surface-overlay-strong)] px-4 py-2 text-sm font-medium text-[color:var(--text-primary)] hover:bg-[color:var(--surface-overlay)]"
 >
 Ver /api/health
 </a>
 ) : null}
