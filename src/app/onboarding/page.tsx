        ...
        <Card className="border-white/10 bg-zinc-900/40">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              O Lex funciona com <span className="text-zinc-200">memória + fontes</span>. Quando a base for insuficiente, ele avisa e evita “chutes”.
            </p>
          </CardHeader>
          <CardContent>
            <form action={completeOnboardingAction} className="space-y-4">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1">
                  <Label htmlFor="officeName">Escritório</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  <label className="flex cursor-pointer items-start gap-2 rounded-lg border border-white/10 bg-zinc-950/30 p-3 text-sm">
        ...
        <Card className="border-white/10 bg-zinc-900/40">
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div className="rounded-lg border border-white/10 bg-zinc-950/40 p-3">
              <p className="font-medium text-zinc-200">1) Abrir processo demo</p>
              <p className="text-xs">Ideal para entender fontes e guardrails em 5 minutos.</p>
            </div>
            <div className="rounded-lg border border-white/10 bg-zinc-950/40 p-3">
              <p className="font-medium text-zinc-200">2) Enviar primeiro documento</p>
              <p className="text-xs">O Lex extrai, segmenta e indexa para recuperação semântica.</p>
            </div>
            <div className="rounded-lg border border-white/10 bg-zinc-950/40 p-3">
              <p className="font-medium text-zinc-200">3) Perguntar e gerar peça</p>
